<template>
  <div>
    <div class="seach">
      <el-input @change="seach" placeholder="Search You Want" v-model="input3" class="input-with-select">
      </el-input>
      ...
      <div>
        <el-form ref="form" :model="form" label-width="100px">
          ...
          <el-form-item label="Category：">
            <el-select @change="ruleclicks" v-model="values" placeholder="Category">
