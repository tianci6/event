    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biaoti = true;
          ...
          if(o=='toupiaoxuanxiang'){
            this.ruleForm.toupiaoxuanxiang = obj[o];
	    this.ro.toupiaoxuanxiang = true;
            continue;
          }
          if(o=='beizhu'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `toupiaotongji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.toupiaotongjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
