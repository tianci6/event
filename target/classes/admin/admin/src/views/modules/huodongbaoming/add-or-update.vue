  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baomingbianhao" label="RegisterNo" prop="baomingbianhao">
              <el-input v-model="ruleForm.baomingbianhao" 
                placeholder="RegisterNo" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="EndTime" prop="jieshushijian">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="RegisterTime" prop="baomingshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.baomingshijian" 
                type="datetime"
                :readonly="ro.baomingshijian"
                placeholder="RegisterTime">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baomingshijian" label="RegisterTime" prop="baomingshijian">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.juminhao!=''&&json.juminhao){
                this.ruleForm.juminhao = json.juminhao
	    		this.ro.juminhao = true;
		}
		if(json.juminxingming!=''&&json.juminxingming){
                this.ruleForm.juminxingming = json.juminxingming
	    		this.ro.juminxingming = true;
		}
		if(json.juminshouji!=''&&json.juminshouji){
                this.ruleForm.juminshouji = json.juminshouji
	    		this.ro.juminshouji = true;
		}
        } else {
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      objcross.baomingrenshu = objcross.baomingrenshu - this.ruleForm.baomingrenshu
	      if(objcross.baomingrenshu<0){
