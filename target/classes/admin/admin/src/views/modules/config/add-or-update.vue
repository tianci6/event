...
export default {
  data() {
    ...
    return {
      addEditForm: {
        btnSaveFontColor: "rgba(0, 0, 0, 1)",
        selectFontSize: "14px",
        btnCancelBorderColor: "rgba(193, 193, 193, 1)",
        ...
        dateBgColor: "#fff",
        btnSaveBorderRadius: "40px 40px 0 40px",
        ...
        btnSaveBgColor: "rgba(227, 201, 176, 1)",
        uploadIconFontColor: "#8c939d",
        textareaBorderColor: "#DCDFE6",
        btnCancelBgColor: "rgba(243, 243, 243, 1)",
        ...
        btnCancelBorderRadius: "40px 40px 0 40px",
        inputBgColor: "#fff",
