  ...
  data() {
	...
	clicknum : false,
      ...
      rules: {
          ...
          changdiquyu: [
                { required: true, message: '场地区域不能为空', trigger: 'blur' },
          ],
          changdianpai: [
          ],
          lianxidianhua: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.changditupian = true;
          ...
          if(o=='changdiquyu'){
            this.ruleForm.changdiquyu = obj[o];
	    this.ro.changdiquyu = true;
            continue;
          }
          if(o=='changdianpai'){
            this.ruleForm.changdianpai = obj[o];
	    this.ro.changdianpai = true;
            continue;
          }
          if(o=='lianxidianhua'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shequchangdi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shequchangdiCrossAddOrUpdateFlag = false;
						 this.parent.search();
