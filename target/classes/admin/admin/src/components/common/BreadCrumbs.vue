<template>
  <el-breadcrumb class="app-breadcrumb" separator="/"
    style="height:40px;backgroundColor:rgba(238, 221, 197, 1);borderRadius:4px;padding:0px 20px 0px 20px;boxShadow:0px 0px 0px #f903d4;borderWidth:0;borderStyle:dotted solid double dashed;borderColor:#ff0000;">
